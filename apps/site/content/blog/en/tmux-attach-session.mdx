...
[tmux tutorial](/blog/tmux-tutorial) sets that model up first.
...
in the [tmux man page](https://man7.org/linux/man-pages/man1/tmux.1.html), which is worth
...
machine, not your laptop. [tmux over SSH](/blog/tmux-ssh) goes into the surrounding setup;
...
[Mosh](https://mosh.org) solves the other half of the problem: it keeps the remote shell alive
...
[tmux from a phone](/blog/tmux-from-phone) works through. The case none of them cover is wanting
...
looking — and without changing how `attach` itself works. The [feature overview](/features) is
the short version, and the [session reference](https://docs.mtmux.com/web-app/sessions) covers
