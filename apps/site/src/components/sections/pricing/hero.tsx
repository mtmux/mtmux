...
export async function PricingHero() {
  ...
  return (
    <header className="container-content pt-(--spacing-section) pb-8 text-center sm:pb-10">
      ...
      <h1 className="mx-auto max-w-[22ch] text-[clamp(1.5625rem,3.7vw,2.6875rem)] leading-[1]">
        {t("title")}
      </h1>
      <p className="mx-auto mt-4 max-w-[54ch] text-[1.0938rem] leading-[1.72] text-text-muted">
        {t("lead")}
      </p>
      {/* Naming the file that enforces the limits is cheap and checkable. */}
      <p className="mx-auto mt-4 max-w-[56ch] text-[0.875rem] leading-[1.7] text-text-faint">
        {t.rich("note", {
          planLink: (chunks) => (
            <a
