// @ts-nocheck
import * as __fd_glob_19 from "../content/docs/web-app/terminal.mdx?collection=docs";
import * as __fd_glob_18 from "../content/docs/web-app/sessions.mdx?collection=docs";
import * as __fd_glob_17 from "../content/docs/web-app/mobile.mdx?collection=docs";
import * as __fd_glob_16 from "../content/docs/web-app/index.mdx?collection=docs";
import * as __fd_glob_15 from "../content/docs/web-app/files.mdx?collection=docs";
import * as __fd_glob_14 from "../content/docs/relay/protocol.mdx?collection=docs";
import * as __fd_glob_13 from "../content/docs/relay/index.mdx?collection=docs";
...
import * as __fd_glob_9 from "../content/docs/pairing.mdx?collection=docs";
...
export const docs = await create.docs(
  ...
  },
  {
    ...
    "pairing.mdx": __fd_glob_9,
    "security.mdx": __fd_glob_10,
    "self-hosting.mdx": __fd_glob_11,
    "troubleshooting.mdx": __fd_glob_12,
    "relay/index.mdx": __fd_glob_13,
    "relay/protocol.mdx": __fd_glob_14,
    "web-app/files.mdx": __fd_glob_15,
    "web-app/index.mdx": __fd_glob_16,
    "web-app/mobile.mdx": __fd_glob_17,
    "web-app/sessions.mdx": __fd_glob_18,
    "web-app/terminal.mdx": __fd_glob_19,
  },
);
